...
def get_schemas():
    """Returns a dictionary of TPC-DS table schemas."""
    schemas = {
...
def main():
    spark = SparkSession.builder.appName("TPC-DS Data Ingestion").getOrCreate()
    schemas = get_schemas()

    for table_name, schema in schemas.items():
        print(f"Processing table: {table_name}")
        input_path = f"/opt/spark/data/{table_name}.dat"
        output_path = f"/opt/spark/data/tpcds_parquet/{table_name}"
